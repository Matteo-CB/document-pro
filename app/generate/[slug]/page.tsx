  ...
  return (
    <DocumentProvider>
      <div className="flex flex-col lg:flex-row min-h-screen bg-background relative overflow-hidden">
        ...
        {/* SIDEBAR (Style) - Cache sur mobile, accessible via un bouton idéalement, ou en bas */}
        ...
        <div className="flex-grow flex flex-col xl:flex-row z-10 relative order-1 lg:order-2">
          {/* ZONE APERÇU (En haut sur mobile pour voir le résultat direct) */}
          <section className="w-full xl:w-1/2 h-[50vh] xl:h-screen overflow-hidden bg-gray-100/80 backdrop-blur-sm flex flex-col border-b xl:border-b-0 border-r-0 xl:border-r border-gray-200 order-1 xl:order-2">
            {/* CORRECTION: Suppression du padding sur mobile (p-0) 
                pour maximiser la largeur disponible pour le DocumentViewer 
             */}
            ...
            {/* FOOTER HIDDENLAB (Visible seulement sur grand écran pour gagner de la place sur mobile) */}
          ...
          {/* ZONE FORMULAIRE (En bas sur mobile) */}
